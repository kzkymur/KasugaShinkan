...
def serch_objects_from_model(model, form, filtering_elements):
    ...
    return serched_topics if len(serched_topics) else Response("request form doesn't match any models. maybe your expected was deleted. please reload.", status=status.HTTP_400_BAD_REQUEST)